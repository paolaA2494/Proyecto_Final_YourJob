                   ...
                   <div className="contact-info mt-3 mr-5 ml-5 pl-5 pr-5">
                       ...
                       <section>
                        <div class="footer_icons text-center">
                            <a className="icon-face text-info mr-1" href="#" target="_blank"><i><FaFacebookF /></i></a>
                            <a className="icon-face text-info mr-1" href="#" target="_blank"><i><FaInstagram /></i></a>
                            <a className="icon-face text-info mr-1" href="#" target="_blank"><i><FaTwitterSquare /></i></a>
                            <a className="icon-face text-info mr-1" href="·" target="_blank"><i><FaLinkedin/></i></a>
