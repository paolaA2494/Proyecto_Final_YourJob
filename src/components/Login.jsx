            ...
            <form className="form-signin mt-5 mb-5">
                <div className="text-center mb-4 ">
                    <img className="mb-4" src={Logo} alt="" width="200" height="200"/>
                        <h1 className="h3 mb-3 font-weight-normal text-info font-weight-bold">Iniciar Sesión</h1>
                        <p>Inicia sesión como Worker o como User</p>
                    </div>

                    <div className="form-label-group text-center">
                        <input 
                        onChange={(event)=>{this.valueToState(event.target.value,'email')}}
                        type="email" 
                        value={this.state.email} id="inputEmail" 
                        ...
                        <div className="form-label-group text-center">
                            <input 
                            onChange={(event)=>{this.valueToState(event.target.value, 'password')}} 
                            type="password" 
